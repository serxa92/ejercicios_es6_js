...
const filterAges2 = ages2.filter((age) => age % 2 === 0);

console.log(filterAges2);
...
const filterStreamers = streamers.filter(
...
const filterStreamers2 = streamers2.filter((streamer) =>
  streamer.name.includes("u")
);

console.log(filterStreamers2);
...
const filterStreamers3 = streamers2.filter((streamer) => {
